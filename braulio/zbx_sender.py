...
class SendEmail(object):
    ...
    def __init__(self):
        ...
        self.mail_smtp_server = 'localhost'
        self.mail_port = '587'
        self.mail_pass = ''
    ...
    def send(self):
        ...
        html = t.render(
            zabbix_name='Test_Zabbix',
            trigger_text=self.mail_head,
            graph=self.mail_graph,
            trigger_url=self.mail_url,
            trigger_details=self.mail_footer,
        ...
        server = smtplib.SMTP(self.mail_smtp_server + ':' + self.mail_port)
            #'smtp.gmail.com:587')
        server.starttls()
